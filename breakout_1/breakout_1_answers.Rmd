...
Let's start by keeping the following variables from raw_dm: USUBJID, STUDYID, SITEID, SUBJID, ARM, AGE, RFSTDTC.  We will assign this subset dataset to just dm.
...
Let's start by subsetting the raw_ae data frame, the code for this is below.

```{r drop_1}
ae <- raw_ae %>% 
  select(USUBJID, AETERM, AEBODSYS, AEDECOD, AESTDTC, AEENDTC, AEOUT)
```
