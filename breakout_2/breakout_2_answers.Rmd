...
We'll pick up where we left off from the last exercise with the subsets on the data.
...
## Left Join
The first type of join we will be doing is a left join.  This keeps the data that is found in the 'left' dataframe and any data from the 'right' data frame that overlaps. 
